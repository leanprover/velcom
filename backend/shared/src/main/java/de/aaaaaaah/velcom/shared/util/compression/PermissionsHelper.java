...
public class PermissionsHelper {
  ...
  private static final Map<Integer, PosixFilePermission> INDEX_PERMISSION_MAP =
      Map.ofEntries(
  ...
  /**
   * Converts a set of {@link java.nio.file.attribute.PosixFilePermission}s to the octal posix mode.
   *
