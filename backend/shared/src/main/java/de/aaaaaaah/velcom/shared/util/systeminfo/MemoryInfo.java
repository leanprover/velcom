...
public class MemoryInfo {
   ...
   *     swapping, in KiB. See also <a
   *     href="https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=34e431b0ae398fc54ea69ff85ec700722c9da773">this
  ...
  /**
   * Creates a {@link MemoryInfo} instance from the "/proc/meminfo" file. <br>
  ...
  public String format() {
    if (totalMemoryKib > 256 * 1024) {
      return String.format(
          "%d MiB total, %d MiB available", totalMemoryKib / 1024, availableMemoryKib / 1024);
    } else {
