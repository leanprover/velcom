...
class CpuInfoTest {
  ...
  void testCounts() {
    ...
    assertThat(cpuInfo.coreModels()).containsExactly("Intel(R) Core(TM) i7-7700HQ CPU @ 2.80GHz");
  }
  ...
  void testModelReturnsSet() {
    ...
    assertThat(cpuInfo.coreModels())
        .containsExactly("Intel(R) Core(TM) i7-7700HQ CPU @ 2.80GHz", "My cool model");
  }
