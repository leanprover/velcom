...
public class BenchResult {
  ...
  private BenchResult(
      UUID runId, Either<String, Result> result, Instant startTime, Instant stopTime) {
   ...
   */
  public static BenchResult successful(
      UUID runId, Result result, Instant startTime, Instant stopTime) {
