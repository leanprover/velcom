...
class CommitReadAccessTest {
  ...
  void setUp(@TempDir Path tempDir) {
    ...
    testDb.addCommit(
        ...
        true,
        "aA",
        Instant.ofEpochSecond(1600010001),
        "cA",
        Instant.ofEpochSecond(1600010002),
        "A");
    testDb.addCommit(
        REPO_ID,
        COMM_B_HASH,
        ...
        true,
        "aB",
        Instant.ofEpochSecond(1600020001),
        "cB",
        Instant.ofEpochSecond(1600020002),
        "B");
    testDb.addCommit(
        REPO_ID,
        COMM_C_HASH,
        ...
        true,
        "aC",
        Instant.ofEpochSecond(1600030001),
        "cC",
        Instant.ofEpochSecond(1600030002),
        "C");
    testDb.addCommit(
        REPO_ID,
        COMM_D_HASH,
        ...
        true,
        "aD",
        Instant.ofEpochSecond(1600040001),
        "cD",
        Instant.ofEpochSecond(1600040002),
        "D");
    testDb.addCommit(
        REPO_ID,
        COMM_E_HASH,
        ...
        true,
        "aE",
        Instant.ofEpochSecond(1600050001),
        "cE",
        Instant.ofEpochSecond(1600050002),
        "E");
    testDb.addCommit(
        REPO_ID,
        COMM_F_HASH,
        ...
        true,
        "aF",
        Instant.ofEpochSecond(1600060001),
        "cF",
        Instant.ofEpochSecond(1600060002),
        "F");
    testDb.addCommit(
        REPO_ID,
        COMM_G_HASH,
        ...
        true,
        "aG",
        Instant.ofEpochSecond(1600070001),
        "cG",
        Instant.ofEpochSecond(1600070002),
        "G");
    testDb.addCommit(
        REPO_ID,
        COMM_H_HASH,
        ...
        true,
        "aH",
        Instant.ofEpochSecond(1600080001),
        "cH",
        Instant.ofEpochSecond(1600080002),
        "H");
    testDb.addCommit(
        REPO_ID,
        COMM_I_HASH,
        ...
        true,
        "aI",
        Instant.ofEpochSecond(1600090001),
        "cI",
        Instant.ofEpochSecond(1600090002),
        "I");
  ...
  private void checkFullCommit(
      ...
      int committerDate,
      String message,
      List<CommitHash> parents,
      List<CommitHash> children) {
  ...
  void getCommit() {
    checkCommit(
        access.getCommit(REPO_ID, COMM_A_HASH),
        REPO_ID,
        COMM_A_HASH,
        true,
        true,
        ...
        "A");
    checkCommit(
        access.getCommit(REPO_ID, COMM_B_HASH),
        REPO_ID,
        COMM_B_HASH,
        true,
        true,
        ...
        "B");
    checkCommit(
        access.getCommit(REPO_ID, COMM_C_HASH),
        REPO_ID,
        COMM_C_HASH,
        true,
        true,
        ...
        "C");
    checkCommit(
        access.getCommit(REPO_ID, COMM_D_HASH),
        REPO_ID,
        COMM_D_HASH,
        true,
        true,
        ...
        "D");
    checkCommit(
        access.getCommit(REPO_ID, COMM_E_HASH),
        REPO_ID,
        COMM_E_HASH,
        true,
        true,
        ...
        "E");
    checkCommit(
        access.getCommit(REPO_ID, COMM_F_HASH),
        REPO_ID,
        COMM_F_HASH,
        true,
        false,
        ...
        "F");
    checkCommit(
        access.getCommit(REPO_ID, COMM_G_HASH),
        REPO_ID,
        COMM_G_HASH,
        true,
        false,
        ...
        "G");
    checkCommit(
        access.getCommit(REPO_ID, COMM_H_HASH),
        REPO_ID,
        COMM_H_HASH,
        false,
        false,
        ...
        "H");
    checkCommit(
        access.getCommit(REPO_ID, COMM_I_HASH),
        REPO_ID,
        COMM_I_HASH,
        false,
        false,
  ...
  void getCommits() {
    ...
    List<Commit> commits =
        access.getCommits(REPO_ID, List.of(COMM_B_HASH, COMM_G_HASH, COMM_I_HASH, nonexistentHash));

    assertThat(commits.stream().map(Commit::getHash))
        .containsExactlyInAnyOrder(COMM_B_HASH, COMM_G_HASH, COMM_I_HASH);

    assertThat(commits.stream().map(Commit::getRepoId).collect(toSet()))
        .containsExactlyInAnyOrder(REPO_ID);

    Map<CommitHash, Commit> commitMap = commits.stream().collect(toMap(Commit::getHash, it -> it));

    checkCommit(
        commitMap.get(COMM_B_HASH),
        REPO_ID,
        COMM_B_HASH,
        true,
        true,
  ...
  void getFullCommit() {
    checkFullCommit(
        access.getFullCommit(REPO_ID, COMM_A_HASH),
        REPO_ID,
        COMM_A_HASH,
        true,
        true,
        ...
        List.of(COMM_B_HASH));
    checkFullCommit(
        access.getFullCommit(REPO_ID, COMM_B_HASH),
        REPO_ID,
        COMM_B_HASH,
        true,
        true,
        ...
        "B",
        List.of(COMM_A_HASH),
        List.of(COMM_C_HASH, COMM_F_HASH));
    checkFullCommit(
        access.getFullCommit(REPO_ID, COMM_C_HASH),
        REPO_ID,
        COMM_C_HASH,
        true,
        true,
        ...
        List.of(COMM_D_HASH));
    checkFullCommit(
        access.getFullCommit(REPO_ID, COMM_D_HASH),
        REPO_ID,
        COMM_D_HASH,
        true,
        true,
        ...
        "D",
        List.of(COMM_C_HASH),
        List.of(COMM_E_HASH, COMM_F_HASH, COMM_H_HASH));
    checkFullCommit(
        access.getFullCommit(REPO_ID, COMM_E_HASH),
        REPO_ID,
        COMM_E_HASH,
        true,
        true,
        ...
        List.of());
    checkFullCommit(
        access.getFullCommit(REPO_ID, COMM_F_HASH),
        REPO_ID,
        COMM_F_HASH,
        true,
        false,
        ...
        1600060002,
        "F",
        List.of(COMM_B_HASH, COMM_D_HASH),
        List.of(COMM_G_HASH, COMM_I_HASH));
    checkFullCommit(
        access.getFullCommit(REPO_ID, COMM_G_HASH),
        REPO_ID,
        COMM_G_HASH,
        true,
        false,
        ...
        List.of());
    checkFullCommit(
        access.getFullCommit(REPO_ID, COMM_H_HASH),
        REPO_ID,
        COMM_H_HASH,
        false,
        false,
        ...
        List.of());
    checkFullCommit(
        access.getFullCommit(REPO_ID, COMM_I_HASH),
        REPO_ID,
        COMM_I_HASH,
        false,
        false,
  ...
  void promoteCommits() {
    ...
    List<FullCommit> commits =
        access.promoteCommits(
            access.getCommits(
                REPO_ID,
                List.of(
                    COMM_A_HASH,
    ...
    Map<CommitHash, FullCommit> commitMap =
        commits.stream().collect(toMap(Commit::getHash, it -> it));

    checkFullCommit(
        commitMap.get(COMM_A_HASH),
        REPO_ID,
        COMM_A_HASH,
        true,
        true,
  ...
  void getTrackedCommitsBetween() {
    ...
    List<Commit> commits =
        access.getTrackedCommitsBetween(
            REPO_ID, Instant.ofEpochSecond(1600030000), Instant.ofEpochSecond(1600080005));
    assertThat(commits.stream().map(Commit::getHash))
        .containsExactlyInAnyOrder(COMM_C_HASH, COMM_D_HASH, COMM_E_HASH);
    ...
    commits =
        access.getTrackedCommitsBetween(
            REPO_ID, Instant.ofEpochSecond(1600040003), Instant.ofEpochSecond(1600050002));
    assertThat(commits.stream().map(Commit::getHash)).containsExactlyInAnyOrder(COMM_E_HASH);

    commits =
        access.getTrackedCommitsBetween(
            REPO_ID, Instant.ofEpochSecond(1600040002), Instant.ofEpochSecond(1600050001));
    assertThat(commits.stream().map(Commit::getHash)).containsExactlyInAnyOrder(COMM_D_HASH);
  }

  @Test
  void getFirstParentOfBranch() {
    assertThat(access.getFirstParentsOfBranch(REPO_ID, BRANCH_T, COMM_A_HASH)).isEmpty();
    assertThat(access.getFirstParentsOfBranch(REPO_ID, BRANCH_T, COMM_B_HASH)).isEmpty();
    assertThat(access.getFirstParentsOfBranch(REPO_ID, BRANCH_T, COMM_C_HASH)).isEmpty();
    assertThat(access.getFirstParentsOfBranch(REPO_ID, BRANCH_T, COMM_D_HASH)).isEmpty();
    assertThat(access.getFirstParentsOfBranch(REPO_ID, BRANCH_T, COMM_E_HASH)).isEmpty();
    ...
    assertThat(access.getFirstParentsOfBranch(REPO_ID, BRANCH_U, COMM_A_HASH)).isEmpty();
    assertThat(access.getFirstParentsOfBranch(REPO_ID, BRANCH_U, COMM_B_HASH)).isEmpty();
    assertThat(access.getFirstParentsOfBranch(REPO_ID, BRANCH_U, COMM_C_HASH)).isEmpty();
    assertThat(access.getFirstParentsOfBranch(REPO_ID, BRANCH_U, COMM_D_HASH)).isEmpty();
    assertThat(access.getFirstParentsOfBranch(REPO_ID, BRANCH_U, COMM_E_HASH))
        .containsExactlyInAnyOrder(COMM_D_HASH);
    assertThat(access.getFirstParentsOfBranch(REPO_ID, BRANCH_U, COMM_F_HASH)).isEmpty();
    assertThat(access.getFirstParentsOfBranch(REPO_ID, BRANCH_U, COMM_G_HASH)).isEmpty();
  ...
  void getCommitsBetween() {
    ...
    List<Commit> commits =
        access.getCommitsBetween(
            REPO_ID,
            List.of(BranchName.fromName("U")),
            Instant.ofEpochSecond(1600020000),
            Instant.ofEpochSecond(1600060005));
    assertThat(commits.stream().map(Commit::getHash))
    ...
    commits =
        access.getCommitsBetween(
            ...
            List.of(BranchName.fromName("U")),
            Instant.ofEpochSecond(1600020000),
            Instant.ofEpochSecond(1600090005));
    assertThat(commits.stream().map(Commit::getHash))
    ...
    commits =
        access.getCommitsBetween(
            REPO_ID,
            List.of(BranchName.fromName("T")),
            Instant.ofEpochSecond(1600020000),
            Instant.ofEpochSecond(1600040005));
    assertThat(commits.stream().map(Commit::getHash))
    ...
    assertThat(commits.stream().map(Commit::getHash))
        .containsExactlyInAnyOrder(
            COMM_B_HASH, COMM_C_HASH, COMM_D_HASH, COMM_E_HASH, COMM_F_HASH, COMM_G_HASH);
    ...
    commits =
        access.getCommitsBetween(
            REPO_ID,
            List.of(BranchName.fromName("T")),
            Instant.ofEpochSecond(1600040003),
            Instant.ofEpochSecond(1600050000));
