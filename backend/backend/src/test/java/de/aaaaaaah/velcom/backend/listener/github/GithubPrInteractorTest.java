    ...
    List<DimensionDifference> differences =
        List.of(
            ...
            new DimensionDifference(
                ...
                new RunId(),
                1000000.0),
            new DimensionDifference(new Dimension("deriv", "maxrss"), 0.0, 10.0, new RunId(), 1.0),
            new DimensionDifference(
                new Dimension("const_fold", "branches"), 100.0, 10.0, new RunId(), null));
    List<Dimension> failed = List.of(new Dimension("const_fold", "instructions"));
