...
class JsonSourceTest extends SerializingTest {
  ...
  void serializeFromCommit() throws JsonProcessingException {
    Object object =
        JsonSource.commitSource(
            new JsonCommitDescription(
  ...
  void serializeFromUploadedTar() throws JsonProcessingException {
    Object object =
        JsonSource.tarSource(
            "descriptionText", UUID.fromString("24dd4fd3-5c6d-4542-a7a4-b181f37295a6"));
    String json =
        "{"
            + "\"type\": \"UPLOADED_TAR\","
            + "\"source\": {"
    ...
    object = JsonSource.tarSource("descriptionText", null);
    json =
        "{"
            + "\"type\": \"UPLOADED_TAR\","
            + "\"source\": {"
