...
public class JsonMeasurement {
  ...
  @Nullable private final List<Double> values;
  @Nullable private final String error;
  @Nullable private final Double stddev;
  @Nullable private final Double stddevPercent;

  private JsonMeasurement(
  ...
  public static JsonMeasurement successful(
      JsonDimension dimension,
      double value,
      List<Double> values,
      Double stddev,
   ...
   */
  public static JsonMeasurement fromMeasurement(
