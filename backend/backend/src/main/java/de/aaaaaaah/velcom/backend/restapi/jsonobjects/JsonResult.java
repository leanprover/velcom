...
public class JsonResult {
  ...
  @Nullable private final List<JsonMeasurement> measurements;
  @Nullable private final String benchError;
  @Nullable private final String velcomError;

  private JsonResult(
      @Nullable List<JsonMeasurement> measurements,
      @Nullable String benchError,
   ...
   * @return the newly created {@link JsonResult}
   */
  public static JsonResult fromMeasurements(
      Collection<Measurement> measurements,
      Map<Dimension, DimensionInfo> dimensionInfos,
      SignificanceFactors significanceFactors,
      boolean allValues) {

    List<JsonMeasurement> jsonMeasurements =
        measurements.stream()
            .map(
                measurement ->
                    JsonMeasurement.fromMeasurement(
                        measurement,
