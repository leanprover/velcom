...
public class CompareEndpoint {
  ...
  public GetReply get(
    ...
    Optional<SignificanceReasons> reasons =
        significanceDetector.getSignificance(run2, List.of(run1), significantDimensions);
    ...
    List<JsonDimensionDifference> differences =
        JsonDimensionDifference.fromRunComparison(comparison, infos);
