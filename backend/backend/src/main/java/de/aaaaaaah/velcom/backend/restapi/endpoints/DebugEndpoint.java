...
public class DebugEndpoint {
  ...
  public GetReply get() {
    ...
    return new GetReply(
        true, GitProperties.getBuildTime(), GitProperties.getHash(), runnerHashes, stats);
  }
  ...
  private static class RunnerInfo {
    ...
    @Nullable public final String hash;
  ...
  private static class Stats {
    ...
    public Stats(
        long outdatedRuns,
        long tarRunsTotal,
        long tarRunsNotAttachedToRepo,
        long tarRunsAttachedToRepo,
        long failedRuns,
        long failedRunErrorMsgChars,
        long runsForUntrackedCommits,
        long runsForUnreachableCommits) {
