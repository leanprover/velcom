...
public class DimensionInfo {
  ...
  public DimensionInfo(
      Dimension dimension, Unit unit, Interpretation interpretation, boolean significant) {
  ...
  public DimensionInfo(
      Dimension dimension, @Nullable Unit unit, @Nullable Interpretation interpretation) {
