...
public class ShortRunDescription {
  ...
  @Nullable private final String commitHash;
  @Nullable private final String commitSummary;
  @Nullable private final String tarDescription;

  public ShortRunDescription(
      RunId id,
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, that.id)
        ...
        && Objects.equals(tarDescription, that.tarDescription);
  }
