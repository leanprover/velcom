...
public class SearchEndpoint {
  ...
  public SearchGetReply get(
    ...
    List<BranchInfo> branches =
        repoAccess.searchBranches(limit, repoId.orElse(null), query).stream()
            .map(BranchInfo::new)
            .collect(toList());
    ...
    List<CommitInfo> commits =
        commitAccess.searchCommits(limit, repoId.orElse(null), query).stream()
    ...
    List<RunInfo> runs =
        benchmarkAccess.searchRuns(limit, repoId.orElse(null), query).stream()
            .map(RunInfo::new)
            .collect(toList());
  ...
  private static class RunInfo {
    ...
    @Nullable public final String repoId;
    @Nullable public final String commitSummary;
    @Nullable public final String tarDescription;
