 ...
 */
public class InvalidQueryParamsExceptionMapper
    implements ExceptionMapper<InvalidQueryParamsException> {

  @Override
  public Response toResponse(InvalidQueryParamsException exception) {
    return Response.status(Status.BAD_REQUEST).entity(new Info(exception.getMessage())).build();
  }
