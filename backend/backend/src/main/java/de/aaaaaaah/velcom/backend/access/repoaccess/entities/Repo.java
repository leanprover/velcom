...
public class Repo {
  ...
  @Nullable private final String githubAccessToken;
  @Nullable private final Instant githubCommentCutoff;

  public Repo(
      RepoId id,
      String name,
      RemoteUrl remoteUrl,
      @Nullable String githubAccessToken,
  ...
  public static class GithubInfo {
    ...
    public boolean equals(Object o) {
      ...
      return Objects.equals(repoName, that.repoName)
          ...
          && Objects.equals(commentCutoff, that.commentCutoff);
    }
