...
import { mdiCheckCircleOutline, mdiProgressAlert, mdiAlertCircleOutline } from "@mdi/js";
...
export default class RunTimeline extends Vue {
  ...
  private get sortedRuns(): RunDescription[] {
    return this.runs.slice().sort((a, b) => b.startTime.getTime() - a.startTime.getTime());
  }
