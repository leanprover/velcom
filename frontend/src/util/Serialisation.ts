import { ComparisonDataPoint, DetailDataPoint, Dimension, Repo, RepoBranch } from "@/store/types";
...
export function toJson(object: unknown): string {
  return JSON.stringify(object, (key, value) => {
    ...
    if (!Object.prototype.hasOwnProperty.call(constructor, "SERIALIZED_NAME")) {
      throw new Error("Constructor has no SERIALIZED_NAME property: " + value.constructor.name);
    }
